...
public class ObjLoader
{
    ...
    /**
     * @param stream
     *            The stream you are reading from, such as FileInputStream or ZipInputStream.
    ...
    {
        ArrayList<Triple<Float, Float, Float>> vertices = new ArrayList<Triple<Float, Float, Float>>();
        ArrayList<Triple<Float, Float, Float>> texCoords = new ArrayList<Triple<Float, Float, Float>>();
        ArrayList<Triple<Float, Float, Float>> normals = new ArrayList<Triple<Float, Float, Float>>();
        ArrayList<Triple<Integer, Integer, Integer>> faceDef = new ArrayList<Triple<Integer, Integer, Integer>>();
        ...
        try
        {
            ...
            while(true)
            {
                ...
                else if(line.startsWith("vt"))
                {
                    ...
                    texCoords.add(new Triple<Float, Float, Float>(new Float(splitString[1]), new Float(splitString[2])));
                }
                else if(line.startsWith("vn"))
                {
                    // Vertex Normal
                    String[] splitString = line.split("\\s+");
                    normals.add(new Triple<Float, Float, Float>(new Float(splitString[1]), new Float(splitString[2]), new Float(splitString[3])));
                }
                else if(line.startsWith("v"))
                {
                    // Vertex
                    String[] splitString = line.split("\\s+");
                    vertices.add(new Triple<Float, Float, Float>(new Float(splitString[1]), new Float(splitString[2]), new Float(splitString[3])));
                }
                else if(line.startsWith("f"))
                {
                    ...
                    while(count < 4)
                    {
                        ...
                        faceDef.add(new Triple<Integer, Integer, Integer>(vertexIndex, texCoordIndex, normalIndex));// texCoordIndex, normalIndex));
                        count++;
                    }
                    if(splitString.length == 5)
                    {
                        ...
                        Triple<Integer, Integer, Integer> fourthVertex = new Triple<Integer, Integer, Integer>(vertexIndex, texCoordIndex, normalIndex);
        ...
        ArrayList<Triple<Float, Float, Float>> vertexArrayList = new ArrayList<Triple<Float, Float, Float>>();
        ...
        ArrayList<Triple<Float, Float, Float>> texCoordArrayList = new ArrayList<Triple<Float, Float, Float>>();
        for(int i = 0; i < arraySize; i++)
        {
        ...
        ArrayList<Triple<Float, Float, Float>> normalArrayList = new ArrayList<Triple<Float, Float, Float>>();
        for(int i = 0; i < arraySize; i++)
        {
